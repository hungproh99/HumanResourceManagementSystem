...
public class RelativeInformation implements Serializable {
    ...
    public RelativeInformation(RelativeInformation value) {
        ...
        this.isDependent = value.isDependent;
    }
     ...
     * <code>human_resource_management.relative_information.is_dependent</code>.
     */
    public RelativeInformation setIsDependent(Boolean isDependent) {
        this.isDependent = isDependent;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.isDependent == null) {
            if (other.isDependent != null)
                return false;
        }
        else if (!this.isDependent.equals(other.isDependent))
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((this.isDependent == null) ? 0 : this.isDependent.hashCode());
        return result;
    }

...
public class TimekeepingStatus implements Serializable {
    ...
    public TimekeepingStatus(TimekeepingStatus value) {
     ...
     * <code>human_resource_management.timekeeping_status.type_id</code>.
     */
    public TimekeepingStatus setTypeId(Long typeId) {
        this.typeId = typeId;
        return this;
    }
     ...
     * <code>human_resource_management.timekeeping_status.name</code>.
     */
    public TimekeepingStatus setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final TimekeepingStatus other = (TimekeepingStatus) obj;
        if (this.typeId == null) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("TimekeepingStatus (");

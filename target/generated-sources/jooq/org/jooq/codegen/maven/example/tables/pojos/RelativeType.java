...
public class RelativeType implements Serializable {
    ...
    public RelativeType(RelativeType value) {
     ...
     */
    public RelativeType setTypeId(Long typeId) {
        this.typeId = typeId;
        return this;
    }
     ...
     */
    public RelativeType setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final RelativeType other = (RelativeType) obj;
        if (this.typeId == null) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("RelativeType (");

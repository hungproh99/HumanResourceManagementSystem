...
public class WorkingPlace extends TableImpl<WorkingPlaceRecord> {
     ...
     */
    public final TableField<WorkingPlaceRecord, LocalDate> START_DATE = createField(DSL.name("start_date"), SQLDataType.LOCALDATE, this, "");

    /**
     * The column
     * <code>human_resource_management.working_place.working_place_status</code>.
     */
    public final TableField<WorkingPlaceRecord, Boolean> WORKING_PLACE_STATUS = createField(DSL.name("working_place_status"), SQLDataType.BIT, this, "");
    ...
    /**
     * The column <code>human_resource_management.working_place.grade_id</code>.
     */
    public final TableField<WorkingPlaceRecord, Long> GRADE_ID = createField(DSL.name("grade_id"), SQLDataType.BIGINT, this, "");
    ...
    public List<ForeignKey<WorkingPlaceRecord, ?>> getReferences() {
        return Arrays.asList(Keys.FKL7P5DF5V5OGY5T8KCMXTT10XN, Keys.FKS257VARMVXKJS0VECV56AGSME, Keys.FKJI3M1JNM02YMVMHV5GT72AKD2, Keys.FK6H05FAWO00DAPM4D8T2FS4CA3, Keys.FKMSDABPYR5VHT6G61NOPMUD2D2);
    }

    private transient Area _area;
    private transient GradeType _gradeType;
    ...
    /**
     * Get the implicit join path to the
     * <code>human_resource_management.grade_type</code> table.
     */
    public GradeType gradeType() {
        if (_gradeType == null)
            _gradeType = new GradeType(this, Keys.FKS257VARMVXKJS0VECV56AGSME);

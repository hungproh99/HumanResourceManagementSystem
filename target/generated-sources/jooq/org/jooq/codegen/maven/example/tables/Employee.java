...
public class Employee extends TableImpl<EmployeeRecord> {
    ...
    /**
     * The column <code>human_resource_management.employee.level</code>.
     */
    public final TableField<EmployeeRecord, Integer> LEVEL = createField(DSL.name("level"), SQLDataType.INTEGER, this, "");

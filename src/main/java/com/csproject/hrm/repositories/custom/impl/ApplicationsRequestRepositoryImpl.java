...
public class ApplicationsRequestRepositoryImpl implements ApplicationsRequestRepositoryCustom {
  ...
  private Select<?> getListApplicationRequestReceive(
    ...
    //            dslContext.select(FORWARDS.APPLICATIONS_REQUEST_ID,
    // FORWARDS.EMPLOYEE_ID).from(FORWARDS);
  ...
  public void updateBonusSalaryByApplicationRequest(
    ...
    //        dslContext
    //            .insertInto(
    //                BONUS_SALARY, BONUS_SALARY.DESCRIPTION, BONUS_SALARY.VALUE,
  ...
  public void updateDayWorkByApplicationRequest(
    ...
    //                        .set(LIST_TIMEKEEPING_STATUS.TIMEKEEPING_STATUS_ID,
    // newTimekeepingStatus)
